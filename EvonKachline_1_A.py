...
#This is used so that the program can figure out if the inputs of tickets are correct and when they run out
...
#Once all of the tickets are sold, this will display with how many buyers there were. 
